...
/**
 * Traduce los claims de un token de Azure AD (Microsoft Entra ID) a autoridades de Spring Security:
 * - claim "scp"   -> autoridades  SCOPE_<scope>   (permisos delegados de la API)
 * - claim "roles" -> autoridades  ROLE_<rol>      (App Roles asignados al usuario)
 */
